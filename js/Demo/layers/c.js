...
addLayer("c", {
    ...
    milestones: {
        ...
        1: {
            ...
            effectDescription:
                "You can toggle beep and boop (which do nothing)",
            toggles: [
    ...
    challenges: {
        11: {
            ...
            onComplete() {}, // Called when you successfully complete the challenge
            onEnter() {},
            onExit() {}
        }
    },
        ...
        stuff: {
            ...
            second: {
                ...
                content: [
                    ...
                    [
                        "row",
                        [["upgrade", 11], "blank", "blank", ["upgrade", 11]]
                    ],
        ...
        "main tab": {
            ...
            content: [
                ...
                [
                    "raw-html",
                    function () {
                        return "<button onclick='makeParticles(textParticle)'>'HI'</button>";
                    }
                ],
    ...
    tooltip() {
        ...
        let tooltip =
            formatWhole(player[this.layer].points) + " " + this.resource;
